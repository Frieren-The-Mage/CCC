...
Very cool submission, I don't know Fenwick Tree
Turns out the Segment Tree solution is very hard
'''

class SortedList:
    def __init__(self, iterable=None, _load=100):
...
for _ in range(t):
    ...
    val += len(games) - games.bisect_right(n) + 1
    games.add(n)
